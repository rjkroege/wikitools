...
func Test_WriteTimeline(t *testing.T) {
	...
	metadatas := []*article.MetaData{
		NewArticleTest("bar0.md", statdate, tagdate, "What I want 0", false),
		NewArticleTest("bar1.md", statdate, statdate, "What I want 1", false),
		NewArticleTest("bar2.md", statdate, tagdate, "What I want 2", false)}
